...
class ChatsPage:
    ...
    def __init__(self, application):
        ...
        self.highlight_popup_menu = PopupMenu(application, self.highlight_list_view.widget)
        self.highlight_popup_menu.add_items(
            ("#" + _("_Edit…"), self.on_edit_highlighted),
            ("", None),
            ("#" + _("Remove"), self.on_remove_highlighted)
        )

        self.popup_menus = (
            self.censor_popup_menu, self.replacement_popup_menu, self.highlight_popup_menu
        )

        for widget, name, title in (
            (self.replacement_list_page, "auto_replace", _("Auto-Replace")),
            (self.censor_list_page, "censor", _("Censor")),
            (self.highlight_list_page, "highlight", _("Highlight"))
        ):
